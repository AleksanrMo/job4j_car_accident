...
@Configuration
@ComponentScan("ru.job4j.accident.config")
@EnableTransactionManagement
public class HbmConfig {

    @Bean
    public DataSource data(@Value("${jdbc.url}") String url, @Value("${jdbc.username}") String username,
     @Value("${jdbc.password}")String password, @Value("${jdbc.driver}") String driver) {
